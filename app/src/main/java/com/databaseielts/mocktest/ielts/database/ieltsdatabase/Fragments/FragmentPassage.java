...
public class FragmentPassage extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_passage, container, false);
    ...
    private void initializePassage(View rootView) {
        ...
        Cursor result = myDatabaseHelper.fetchReadingPassage(1, 1);
